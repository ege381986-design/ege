...
Flask'tan Django'ya çevrilen kütüphane yönetim sistemi ayarları
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-in-production-your-secret-key-here')
